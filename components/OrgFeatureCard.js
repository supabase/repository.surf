...
const OrgFeatureCard = ({ org }) => {
  return (
    <Link href={`/${org.login}`}>
    <div className="col-span-12 lg:col-span-4 bg-dark-600 rounded-md px-6 py-6 flex shadow-none transition transform hover:-translate-y-1 hover:shadow-xl cursor-pointer">
